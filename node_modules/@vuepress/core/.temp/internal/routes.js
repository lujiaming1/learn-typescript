...
import GlobalLayout from "/Users/wangchen/lujiaming/Vue/vuepress-starter/node_modules/@vuepress/core/lib/client/components/GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-43181f04").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-71060d57").then(next)
    },
  },
  {
    name: "v-5d93f1b7",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-5d93f1b7").then(next)
    },
  },
  {
    name: "v-b1564aac",
